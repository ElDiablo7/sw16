  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="bg-gradient-to-br from-[#1B8751] to-[#126b3e] rounded-3xl p-8 md:p-16 text-center text-white shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/quote"
              className="w-full sm:w-auto px-8 py-4 bg-white text-[#1B8751] rounded-full font-semibold hover:bg-gray-50 transition-colors shadow-lg text-center"
            >
              Get Free Quote
            </Link>
            <a 
