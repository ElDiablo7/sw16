      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block relative w-40 h-12 group perspective-1000">
              <Image 
                src="/logo.jpg" 
                alt="SW16 Moves Logo" 
                fill 
                className="object-contain drop-shadow-[0_4px_6px_rgba(212,175,55,0.3)] transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-1"
              />
            </Link>
