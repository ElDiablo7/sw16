    ...
    <div className="w-full max-w-3xl mx-auto mb-12">
      <div className="relative flex justify-between">
        ...
        <div className="absolute top-5 left-0 w-full h-[2px] bg-gray-200 -z-10">
          <div 
            className="h-full bg-[#1B8751] transition-all duration-500 ease-in-out" 
            ...
            <div key={index} className="flex flex-col items-center relative z-10 w-24">
              <div 
                className={cn(
                  ...
                  isCompleted ? "bg-[#1B8751] text-white" : 
                  isCurrent ? "bg-white border-2 border-[#1B8751] text-[#1B8751] shadow-[0_0_0_4px_rgba(27,135,81,0.1)]" : 
              ...
              <span 
                className={cn(
                  ...
                  isCurrent ? "text-[#1B8751]" : isCompleted ? "text-gray-800" : "text-gray-400"
                )}
              >
